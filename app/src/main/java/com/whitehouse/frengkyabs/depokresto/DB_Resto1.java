...
public class DB_Resto1 extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        values.put("menu",R.drawable.casa);
        ...
        values.put("menu",R.drawable.kopibar);
        ...
        values.put("menu",R.drawable.chit);
        ...
        values.put("menu",R.drawable.kerang);
        ...
        values.put("tlp"," ");
        values.put("menu",R.drawable.kawa);
        ...
        values.put("_id", 32);
        values.put("nama", "Clemmons");
        values.put("location", "Margo City Lantai 2, Jl. Margonda Raya, Kemiri Muka, Beji, Kota Depok, Jawa Barat 16423");
        values.put("latitude", -6.372412);
        values.put("longitude", 106.835506);
        values.put("open","10:00 - 22:00");
        values.put("tlp","0896-5453-2656");
        values.put("menu",R.drawable.cle);
        values.put("img", R.drawable.bgcle);
        db.insert("restaurant", null, values);
        ...
        values.put("_id", 34);
        values.put("nama", "Bunda Dimsum");
        values.put("location", "Jl. Margonda Raya No.377, RT.2/RW.8, Pd. Cina, Beji, Kota Depok, Jawa Barat 16424");
        values.put("latitude", -6.369543);
        values.put("longitude", 106.832233);
        values.put("open","10:30 - 20:00");
        values.put("tlp","0857-5993-9939");
        values.put("menu",R.drawable.bunda);
        values.put("img", R.drawable.bgbunda);
        db.insert("restaurant", null, values);
        ...
        values.put("open","11:30 - 21:30");
        values.put("tlp","(021) 78891854");
        values.put("menu",R.drawable.shilin);
        ...
        values.put("menu",R.drawable.kfc);
        ...
        values.put("_id", "41");
        values.put("nama", "Ichiban Crepes");
        values.put("location", " Margonda Raya No.1, Pd. Cina, Beji, Kota Depok, Jawa Barat 16424");
        values.put("latitude", -6.374448);
        values.put("longitude", 106.839386);
        values.put("open","10:00 - 21:00");
        values.put("tlp","(021) 95628479");
        values.put("menu","  ");
        values.put("img", R.drawable.bgcrepes);
        db.insert("restaurant", null, values);
        ...
        values.put("menu",R.drawable.tanoshi);
