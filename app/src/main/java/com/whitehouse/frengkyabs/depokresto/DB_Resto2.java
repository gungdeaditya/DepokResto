...
public class DB_Resto2 extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        values.put("menu",R.drawable.moo);
        ...
        values.put("open","10:00 - 22:00");
        values.put("tlp"," ");
        values.put("menu",R.drawable.fatmom);
        ...
        values.put("_id", 23);
        values.put("nama", "Felo Restaurant");
        values.put("location","Jl. Akses Ui, Tugu, Cimanggis, Kota Depok, Jawa Barat 16451");
        values.put("latitude", -6.355314);
        values.put("longitude", 106.852855);
        values.put("open","10:00 - 22:00");
        values.put("tlp","(021) 8724356");
        values.put("menu",R.drawable.felo);
        values.put("img", R.drawable.bgfelo);
        db.insert("resto", "null", values);
        ...
        values.put("open","10:00 - 22:00");
        values.put("tlp","021 78870840");
        values.put("menu",R.drawable.warjo);
